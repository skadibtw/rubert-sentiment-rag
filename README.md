...
The default config now builds the index over the full corpus. If you want a faster local smoke run, set `sample_size:` in `configs/build_rag_index.yaml`.
...
The retrieval layer works out of the box without any extra credentials.
